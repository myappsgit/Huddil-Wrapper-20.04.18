...
@SqlResultSetMappings({
		@SqlResultSetMapping(name = "sync_details", classes = {
				@ConstructorResult(targetClass = SyncDetails.class, columns = { @ColumnResult(name = "tcps"),
						@ColumnResult(name = "appVersion"), @ColumnResult(name = "offers"),
						@ColumnResult(name = "messages"), @ColumnResult(name = "name") }) }),
...
public class UserDetails implements java.io.Serializable {
	...
	public UserDetails(String firstName, String lastName, String addressingName, String userName, String emailId,
			String companyName, String gender, Date dob, int age, String mobileNo, String address, String city,
			String country, String pincode, String website, int isActive, Date signedUp, Authorization authorization,
