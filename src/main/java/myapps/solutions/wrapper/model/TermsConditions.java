...
@SqlResultSetMappings({
		@SqlResultSetMapping(name = "tcps", classes = {
				@ConstructorResult(targetClass = TermsConditions.class, columns = { @ColumnResult(name = "id"),
						@ColumnResult(name = "description") }) }),
		@SqlResultSetMapping(name = "view_terms", classes = {
				@ConstructorResult(targetClass = ViewTerms.class, columns = { @ColumnResult(name = "id"),
						@ColumnResult(name = "userType"), @ColumnResult(name = "PolicyActiveDate"),
						@ColumnResult(name = "PolicyCreateDate") }) }) })
